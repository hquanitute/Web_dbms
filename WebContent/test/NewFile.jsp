...
<head>
	...
	<meta charset="UTF-8" />
	<meta name="keywords" content="Beauty Spa"
	/>
	<!-- //Meta tag Keywords -->

	<!-- Custom-Files -->
	<!-- Bootstrap-Core-CSS -->
	<link rel="stylesheet" href="source/home/bootstrap.css">
	<!-- pop up box -->
	<link href="source/home/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
	<!-- gallery light box -->
	<link href="source/home/lsb.css" rel="stylesheet" type="text/css" media="all">
	<!-- Style-CSS -->
	<link rel="stylesheet" href="source/home/style.css" type="text/css" media="all" />
	<!-- Font-Awesome-Icons-CSS -->
	<link rel="stylesheet" href="source/home/fontawesome-all.css">
	<!-- //Custom-Files -->
...
<body data-spy="scroll" data-target=".fixed-top">
	...
	<div class="bottom-agile py-5" id="about">
		<div class="container py-xl-5 py-lg-3">
			<div class="about-top p-xl-5 p-sm-4 p-3 text-center">
				...
				<img src="source/images/bo2.png" alt="" class="img-fluid">
			</div>
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-lg-5 right-treat-w3l text-lg-right text-center px-lg-0">
						<img src="source/images/treat3.png" alt="" class="img-fluid">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row text-sm-left text-center">
				<div class="col-lg-3 col-sm-6 service-grid">
					<img src="source/images/s1.jpg" alt="" class="img-fluid">
				...
				<div class="col-lg-3 col-sm-6 service-grid mt-sm-0 mt-4">
					<img src="source/images/s2.jpg" alt="" class="img-fluid">
				...
				<div class="col-lg-3 col-sm-6 service-grid mt-lg-0 mt-sm-5 mt-4">
					<img src="source/images/s3.jpg" alt="" class="img-fluid">
					<h4 class="text-capitalize text-dark  my-sm-4 my-3">facial peelings</h4>
					<p>Negrar èla storia di uoini donne dediti alla Nullam dui dolor, sagittis ut nte eget.</p>
				</div>
				<div class="col-lg-3 col-sm-6 service-grid mt-lg-0 mt-sm-5 mt-4">
					<img src="source/images/s4.jpg" alt="" class="img-fluid">
			...
			<div class="row w3_services_grids">
				<div class="col-md-3 col-6 w3ls_team_grid">
					<div class="w3ls_team_grid1 hover15">
						<figure class="mb-0">
							<img src="source/images/t1.jpg" alt=" " class="img-fluid" />
						</figure>
				...
				<div class="col-md-3 col-6 w3ls_team_grid">
					<div class="w3ls_team_grid1 hover15">
						<figure class="mb-0">
							<img src="source/images/t2.jpg" alt=" " class="img-fluid" />
						</figure>
						<div class="w3ls_team_grid1_pos">
							<ul class="social-icons">
								<li>
				...
				<div class="col-md-3 col-6 w3ls_team_grid mt-md-0 mt-4">
					<div class="w3ls_team_grid1 hover15 w3l-tem-k">
						<figure class="mb-0">
							<img src="source/images/t3.jpg" alt=" " class="img-fluid" />
						</figure>
						<div class="w3ls_team_grid1_pos">
							<ul class="social-icons">
								<li>
				...
				<div class="col-md-3 col-6 w3ls_team_grid mt-md-0 mt-4">
					<div class="w3ls_team_grid1 hover15 w3l-tem-k-2">
						<figure class="mb-0">
							<img src="source/images/t4.jpg" alt=" " class="img-fluid" />
						</figure>
						<div class="w3ls_team_grid1_pos">
							<ul class="social-icons">
								<li>
		...
		<div class="container-fluid pb-xl-5 pb-lg-3">
			...
			<div class="row w3layouts_gallery_grids">
				<div class="col-md-3 col-sm-6 w3layouts_gallery_grid p-0">
					<a href="source/images/g1.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
							<img src="source/images/g1.jpg" alt=" " class="img-fluid">
				...
				<div class="col-md-3 col-sm-6 w3layouts_gallery_grid p-0">
					<a href="source/images/g2.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
							<img src="source/images/g2.jpg" alt=" " class="img-fluid">
							<div class="w3layouts_news_grid_pos">
								<div class="wthree_text">
									<h3 class="text-white font-weight-bold">Beauty Spa</h3>
								</div>
				...
				<div class="col-md-3 col-sm-6 w3layouts_gallery_grid p-0">
					<a href="source/images/g3.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
							<img src="source/images/g3.jpg" alt=" " class="img-fluid">
							<div class="w3layouts_news_grid_pos">
								<div class="wthree_text">
									<h3 class="text-white font-weight-bold">Beauty Spa</h3>
								</div>
				...
				<div class="col-md-3 col-sm-6 w3layouts_gallery_grid p-0">
					<a href="source/images/g4.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
			...
			<div class="row w3layouts_gallery_grids">
				<div class="col-md-3 col-sm-6 w3layouts_gallery_grid p-0">
					<a href="source/images/g5.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
							<img src="source/images/g5.jpg" alt=" " class="img-fluid">
							<div class="w3layouts_news_grid_pos">
								<div class="wthree_text">
									<h3 class="text-white font-weight-bold">Beauty Spa</h3>
								</div>
				...
				<div class="col-md-3 col-sm-6 w3layouts_gallery_grid p-0">
					<a href="source/images/g6.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
							<img src="source/images/g6.jpg" alt=" " class="img-fluid">
							<div class="w3layouts_news_grid_pos">
								<div class="wthree_text">
									<h3 class="text-white font-weight-bold">Beauty Spa</h3>
								</div>
				...
				<div class="col-md-3 col-sm-6 w3layouts_gallery_grid p-0">
					<a href="source/images/g7.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
							<img src="source/images/g7.jpg" alt=" " class="img-fluid">
							<div class="w3layouts_news_grid_pos">
								<div class="wthree_text">
									<h3 class="text-white font-weight-bold">Beauty Spa</h3>
								</div>
				...
				<div class="col-md-3 col-sm-6 w3layouts_gallery_grid p-0">
					<a href="source/images/g8.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
							<img src="source/images/g8.jpg" alt=" " class="img-fluid">
							<div class="w3layouts_news_grid_pos">
								<div class="wthree_text">
									<h3 class="text-white font-weight-bold">Beauty Spa</h3>
								</div>
	...
	<!-- JavaScript -->
	<script src="source/js_home/jquery-2.2.3.min.js"></script>
	<!-- Default-JavaScript-File -->

	<script src="source/js_home/bootstrap.js"></script>

	<!-- Text effect -->
	<script src="source/js_home/text_effect.js"></script>
	
	<!-- pop-up-box -->
	<script src="source/js_home/jquery.magnific-popup.js"></script>

	<!-- particles (bg effect) -->
	<script src="source/js_home/jquery.canvas.particles.min.js"></script>

	<!-- gallery light box -->
	<script src="source/js_home/lsb.min.js"></script>

	<!-- smooth scrolling -->
	<script src="source/js_home/SmoothScroll.min.js"></script>

	<!-- move-top -->

	<!-- easing -->
	<script src="source/js_home/easing.js"></script>

	<!--  necessary snippets for few javascript files -->
	<script src="source/js_home/beauty_spa.js"></script>
