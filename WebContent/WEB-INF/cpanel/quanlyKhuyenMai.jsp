<%@page import="Object.KhuyenMai"%>
<%@page import="Object.dsKhuyenMai"%>
...
<body class="hold-transition skin-purple sidebar-mini">
	<div class="wrapper">
        ...
        <li class="active"><a href="redirectKhuyenMai"><i class="fa fa-dollar"></i> <span>Khuyến mãi</span></a></li>
						...
						<div class="card-header card-header-primary">
							<div class="row">
								<h4 class="card-title col-xs-4 my-auto ml-sm-5">Danh sách
									dịch vụ</h4>
								<a href="redirectAddSale">+ Thêm khuyến mãi</a>
							</div>
						</div>
						<div class="card-body">
								...
								<table class="table table-striped">
									<thead>
										<tr>
											...
											<th scope="col">Thời gian và lý do</th>
											<th scope="col">Mã DV</th>
										</tr>
									</thead>
									<tbody>
										<%
											dsKhuyenMai obj = (dsKhuyenMai) request.getAttribute("dsKM");
											List<KhuyenMai> ds = (List<KhuyenMai>) obj.getDs();
										%>
										...
										<tr>
											<td><%=i+1%></td>
											<td><%=ds.get(i).getTenKM()%></td>
											<td><%=ds.get(i).getThoiGian()%></td>
											<td><%=ds.get(i).getMaDV()%></td>
											<td><a href="redirectEditSale?makm=<%=ds.get(i).getMaKM()%>&
											tenkm=<%=ds.get(i).getTenKM()%>&
											madv=<%=ds.get(i).getMaDV()%>&
											thoigian=<%=ds.get(i).getThoiGian()%>
											">Sửa</a></td>
											<td><a href="deleteSale?makm=<%=ds.get(i).getMaKM()%>">Xóa</a></td>
										</tr>
										<%
											}
										%>
