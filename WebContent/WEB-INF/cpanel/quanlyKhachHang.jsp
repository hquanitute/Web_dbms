		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a href="#jsp"><i class="fa fa-home"></i>
							<span>Trang chủ</span></a></li>
					<li class="active"><a href="#"><i class="fa fa-users"></i> <span>Khách
								hàng</span></a></li>
					<li><a href="#"><i class="fa fa-user-circle"></i> <span>Nhân
								viên</span></a></li>
					<li><a href="#"><i class="fa fa-line-chart"></i> <span>Báo
								cáo</span></a></li>
					<li><a href="#"><i class="fa fa-asterisk"></i> <span>Dịch
								vụ</span></a></li>
					<li><a href="#"><i class="fa fa-cubes"></i> <span>Sản
								phẩm</span></a></li>
					<li><a href="#"><i class="fa fa-id-card"></i> <span>Hóa
								đơn</span></a></li>
					<li><a href="#"><i class="fa fa-archive"></i> <span>Kho</span></a></li>
					<li><a href="#"><i class="fa fa-dollar"></i> <span>Khuyến
								mãi</span></a></li>
					<li><a href="#"><i class="fa fa-user-o"></i> <span>Tài
								khoản</span></a></li>
					<li><a href="#"><i class="fa fa-info"></i> <span>Thông
								tin</span></a></li>
				</ul>
				<!-- /.sidebar-menu -->
			</section>
